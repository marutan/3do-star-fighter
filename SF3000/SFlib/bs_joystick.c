...
stickFilter(BS_StickData *aStk, long recalibrate)
{
  ...
  xtmp = (short) BS_XRES * (xtmp - BS_GetStickMinX(aStk)) /
         (BS_GetStickMaxX(aStk) - BS_GetStickMinX(aStk));
  ytmp = (short) BS_YRES * (ytmp - BS_GetStickMinY(aStk)) /
         (BS_GetStickMaxY(aStk) - BS_GetStickMinY(aStk));
  ztmp = (short) BS_ZRES * (ztmp - BS_GetStickMinZ(aStk)) /
         (BS_GetStickMaxZ(aStk) - BS_GetStickMinZ(aStk));
