 ...
 *
 *	History:
 *	10/06/94		dtc		Added some default constants and
 *UseDefaultStreamHeader function. 09/14/94		dtc		Removed
 *typedef from enum declaration. 10/20/93		jb		New
 *today
 *
 *******************************************************************************************/
...
#define SNDS_CHUNK_TYPE                                                        \
  CHAR4LITERAL('S', 'N', 'D', 'S') /* chunk type for this subscriber */
#define FILM_CHUNK_TYPE                                                        \
  CHAR4LITERAL('F', 'I', 'L', 'M') /* chunk type for this subscriber */
...
#define kEnableAudioChanMask                                                   \
  14 /* mask of audio channels to enable (enable channels 1-3) */
