...
long
return_mission(pyramid *pyramid_ptr)
...
long
return_missionpos(long x_pos, long y_pos)
...
// Purpose : Returns total of given number (ie. total + (total-1) + (total-2)
// until <0) Accepts : it Returns : total of it
