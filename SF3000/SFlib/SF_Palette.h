...
#define RED_15                                                                 \
  0x7c00 // Colour Definitions for 16bpp colour entries (0-31 for RGB, top bit
         // left clear)
...
void palette_set(long p_red, long p_green,
                 long p_blue); // Set screen palette with component scales
