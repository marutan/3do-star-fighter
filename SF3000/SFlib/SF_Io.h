...
void io_resetvideocounter(
    long); // Sets number of frames without input prior to video, (-ve is never)
...
long controlpad_constant(void); // Return's last keypad registered in
                                // controlpad_debounce (undebounced)
