...
#define GROUND_SWEAPONBONUS1                                                   \
  1 // Definitions for ground & ship bonus/object types
...
typedef struct performance_data // Performance rating of a given ship
{
  ...
  long weapons[13]; // PLAYERS SHIP     /	COMPUTER SHIP | SATELLITE (Array
                    // of weapons in THIS ORDER)
...
typedef struct mission_data // Complete data set for active mission
{
  ...
  long difficulty;      // Rate of ground fire / A-T-A rate / Ground Launch rate
                        // (0-1023)
