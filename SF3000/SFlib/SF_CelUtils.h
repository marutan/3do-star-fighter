...
void cel_rectangle(long, long, long, long, long, long,
                   long); // Draw a shaded rectangle
void cel_paint(long xpos, long ypos, long shade,
               long cel);   // Immediately draw a cel
...
void cel_getalphastart(
    alpha_char *);            // Set a chars start points depending on add mode
