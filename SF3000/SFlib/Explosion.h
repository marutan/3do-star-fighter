...
ship_stack *add_ship_explosion_section(ship_stack *, long, long);

void add_section_smoke(long, long, long, long, long, long, long, long, long,
                       long);

void explode_static_graphic(long, long, long);
void static_explode(long, long);
void add_explosion_line(long, long, long, long, long, long, long, long, long,
...
ship_stack *add_explosion_section(long, long, long, long, long, long, long,
                                  long, long);

void explosion_section_control(ship_stack *);

void find_group_centre_point(collision_details_header *, ship_stack *, long);

void explode_static_from_collision_box(long grid_ref, long explosion_velocity,
                                       long owner, long style, long);
