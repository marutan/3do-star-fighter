...
#define DELAY_EXPLODE_THIS_GRAPHIC                                             \
  explode_next_frame((x_grid + (y_grid << 7)));                                \
  break;

// Static Explosion Styles
#define STATIC_EXPLODE_NOT                                                     \
  collision_map[y_grid][x_grid] = 255;                                         \
  break;
...
#define STATIC_EXPLODE_SMALL_FAST_MUSHROOM                                     \
  explode_static_graphic(x_grid, y_grid, 3);
#define STATIC_EXPLODE_MEDIUM explode_static_graphic(x_grid, y_grid, 4);
#define STATIC_EXPLODE_MEDIUM_MUSHROOM                                         \
  explode_static_graphic(x_grid, y_grid, 5);
#define STATIC_EXPLODE_MEDIUM_FAST explode_static_graphic(x_grid, y_grid, 6);
#define STATIC_EXPLODE_MEDIUM_FAST_MUSHROOM                                    \
  explode_static_graphic(x_grid, y_grid, 7);
...
#define STATIC_EXPLODE_BIG_FAST_MUSHROOM                                       \
  explode_static_graphic(x_grid, y_grid, 11);
#define STATIC_EXPLODE_MEGATOWER_2_GROUPS                                      \
  explode_static_graphic(x_grid, y_grid, 12);
#define STATIC_EXPLODE_TOWER_1_GROUP explode_static_graphic(x_grid, y_grid, 13);
#define STATIC_EXPLODE_STAR_TOWER_4_GROUPS                                     \
  explode_static_graphic(x_grid, y_grid, 14);
#define STATIC_EXPLODE_PALACE_REL_3_GROUPS                                     \
  explode_static_graphic(x_grid, y_grid, 15);

#define STATIC_REPLACE_WITH                                                    \
  collision_map[y_grid][x_grid] = 50;                                          \
  poly_map[y_grid][x_grid] =
