...
#define MAX_MENUS 18         // Max number of menus available
...
#define CEL_MAX32 88 // Max Number of K for 32x32 object textures
#define CEL_MAX16 40 // Max Number of K for 16x16 landscape textures
#define CEL_MAX4 210 // Max Number of 4x4 landscape textures
#define CEL_MAXTEMP                                                            \
  1024 // Max Number of temporary cels per frame - also in ARMCell.s !
#define CEL_MAXCREATION 256 // Max Number of 'created' cel space
#define CEL_MAXGAME                                                            \
  44 // Ammount of memory to allocate to fixed game sprites in K
