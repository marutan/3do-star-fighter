...
long
test_display_static_graphics(long test_graphic)
{
...
void
explosion_check_this_graphic(long x_grid, long y_grid)
{
...
void
explosion_check_earth_land_graphics(long x_grid, long y_grid)
{
...
void
explosion_next_frame_earth_land_graphics(long x_grid, long y_grid)
{

  // Certain graphics which link onto others must die if they are no longer
  // connected
...
void
check_bonus_earth_land_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_earth_land_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > EL_MAX) {
    test_graphic = 1;
  }
...
void
explosion_check_earth_sea_graphics(long x_grid, long y_grid)
{
...
void
explosion_next_frame_earth_sea_graphics(long x_grid, long y_grid)
{
...
void
check_bonus_earth_sea_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_earth_sea_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > ES_MAX) {
    test_graphic = 1;
  }
...
void
explosion_check_chemical_graphics(long x_grid, long y_grid)
{
...
void
explosion_next_frame_chemical_graphics(long x_grid, long y_grid)
{
...
void
check_bonus_chemical_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_chemical_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > CM_MAX) {
    test_graphic = 1;
  }
...
void
explosion_check_thorg_graphics(long x_grid, long y_grid)
{
...
void
explosion_next_frame_thorg_graphics(long x_grid, long y_grid)
{
...
void
check_bonus_thorg_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_thorg_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > TH_MAX) {
    test_graphic = 1;
  }
...
void
explosion_check_space_graphics(long x_grid, long y_grid)
{
...
void
check_bonus_space_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_space_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > SP_MAX) {
    test_graphic = 1;
  }
...
void
explosion_check_death_star_graphics(long x_grid, long y_grid)
{
...
void
explosion_next_frame_death_star_graphics(long x_grid, long y_grid)
{
...
void
check_bonus_death_star_graphics(long x_grid, long y_grid)
{
  long type;
...
long
test_display_death_star_graphics(long test_graphic)
{

  test_graphic += 1;
  if (test_graphic > DS_MAX) {
    test_graphic = 1;
  }
