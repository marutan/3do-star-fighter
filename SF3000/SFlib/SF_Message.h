...
{
  long message_id, timer, flags, cursor, delay, scroll_speed;
  TextCel *textcel;
} message;
...
void message_add(long, long, long, long, long,
                 long); // Display a game message of given type
void message_text(long, char *, long, long, long, long); // Display game text
void message_addxy(long, char *, long, long, long, long, long, long, long, long,
                   long);  // Display a game message at X,Y
...
long message_initialisemissionfiles(long, long,
                                    long); // Load in mission text message
void
message_initialiselanguagefiles(long); // Load in language message / menu files
