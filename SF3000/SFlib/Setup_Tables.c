...

{
  ...
  if (graphics_data[3] != 193543) {
    ...
    for (loop = 0; loop < 64; loop += 1) {
      if (reloc->graphic_adr != 0) {
        reloc->graphic_adr += (long) (static_graphics_adr);
      }
      if (reloc->explosion_adr != 0) {
        reloc->explosion_adr += (long) (static_graphics_adr);
      }
      if (reloc->collision_adr != 0) {
        reloc->collision_adr += (long) (static_graphics_adr);
      }
      if (reloc->laser_data != 0) {
        reloc->laser_data += (long) (static_graphics_adr);
      }
      if (reloc->missile_data != 0) {
        reloc->missile_data += (long) (static_graphics_adr);
      }
      if (reloc->ship_data != 0) {
        reloc->ship_data += (long) (static_graphics_adr);
      }
      if (reloc->smoke_data != 0) {
        reloc->smoke_data += (long) (static_graphics_adr);
      }
      if (reloc->thruster_data != 0) {
        reloc->thruster_data += (long) (static_graphics_adr);
      }

      // Fix min height for missile aim
      if (reloc->missile_aim < (1 << 22)) {
        reloc->missile_aim = (1 << 22);
      }

      // Fix score
      if (reloc->score <= 0) {
        reloc->score = (25 * (arm_random() & 255));
      }
      ...
      if (reloc->extra_data != 0) {
        ...
        if (section_group_data->group_0 != 0) {
          section_group_data->group_0 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_1 != 0) {
          section_group_data->group_1 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_2 != 0) {
          section_group_data->group_2 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_3 != 0) {
          section_group_data->group_3 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_4 != 0) {
          section_group_data->group_4 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_5 != 0) {
          section_group_data->group_5 += (long) (static_graphics_adr);
        }
        if (section_group_data->group_6 != 0) {
          section_group_data->group_6 += (long) (static_graphics_adr);
        }
    ...
    for (loop = 0; loop < 128; loop += 1) {
      if (reloc->graphic_adr != 0) {
        reloc->graphic_adr += (long) (ships_adr);
      }
      if (reloc->explosion_adr != 0) {
        reloc->explosion_adr += (long) (ships_adr);
      }
      if (reloc->collision_adr != 0) {
        reloc->collision_adr += (long) (ships_adr);
      }
      if (reloc->laser_data != 0) {
        reloc->laser_data += (long) (ships_adr);
      }
      if (reloc->missile_data != 0) {
        reloc->missile_data += (long) (ships_adr);
      }
      if (reloc->ship_data != 0) {
        reloc->ship_data += (long) (ships_adr);
      }
      if (reloc->smoke_data != 0) {
        reloc->smoke_data += (long) (ships_adr);
      }
      if (reloc->thruster_data != 0) {
        reloc->thruster_data += (long) (ships_adr);
      }
      // if(reloc->ship_2_data != 0)			reloc->ship_2_data +=
      // (long) (ships_adr) ;
      ...
      if (reloc->extra_data != 0) {
        ...
        if (section_group_data->group_0 != 0) {
          section_group_data->group_0 += (long) (ships_adr);
        }
        if (section_group_data->group_1 != 0) {
          section_group_data->group_1 += (long) (ships_adr);
        }
        if (section_group_data->group_2 != 0) {
          section_group_data->group_2 += (long) (ships_adr);
        }
        if (section_group_data->group_3 != 0) {
          section_group_data->group_3 += (long) (ships_adr);
        }
        if (section_group_data->group_4 != 0) {
          section_group_data->group_4 += (long) (ships_adr);
        }
        if (section_group_data->group_5 != 0) {
          section_group_data->group_5 += (long) (ships_adr);
        }
        if (section_group_data->group_6 != 0) {
          section_group_data->group_6 += (long) (ships_adr);
        }
      }
      ...
      if (loop == 0) {
        ...
        //	players_ship_graphic.ship_2_data		=
        //reloc->ship_2_data ;
    ...
    for (loop = 0; loop < 16; loop += 1) {
      if (reloc->graphic_adr != 0) {
        reloc->graphic_adr += (long) (explosion_bits_adr);
      }
      if (reloc->explosion_adr != 0) {
        reloc->explosion_adr += (long) (explosion_bits_adr);
      }
      if (reloc->collision_adr != 0) {
        reloc->collision_adr += (long) (explosion_bits_adr);
      }
      if (reloc->laser_data != 0) {
        reloc->laser_data += (long) (explosion_bits_adr);
      }
      if (reloc->missile_data != 0) {
        reloc->missile_data += (long) (explosion_bits_adr);
      }
      if (reloc->ship_data != 0) {
        reloc->ship_data += (long) (explosion_bits_adr);
      }
      if (reloc->smoke_data != 0) {
        reloc->smoke_data += (long) (explosion_bits_adr);
      }
      if (reloc->thruster_data != 0) {
        reloc->thruster_data += (long) (explosion_bits_adr);
      }
      // if(reloc->ship_2_data != 0)			reloc->ship_2_data +=
      ...
      if (type != 0 && type < 64) {
        ...
        if (y_size > 0) {
          for (coll_loop = 1; coll_loop <= y_size; coll_loop += 1) {
            ...
            if (x_size > 0) {
              poly_map[((loop2 + coll_loop) & 127)][((loop - 1) & 127)] =
                  COLL_DOWN_RIGHT;
              poly_map[((loop2 - coll_loop) & 127)][((loop - 1) & 127)] =
                  COLL_UP_RIGHT;
            ...
            if (x_size > 1) {
              poly_map[((loop2 + coll_loop) & 127)][((loop - 2) & 127)] =
                  COLL_DOWN_RIGHT;
              poly_map[((loop2 - coll_loop) & 127)][((loop - 2) & 127)] =
                  COLL_UP_RIGHT;
            ...
            if (x_size > 2) {
              poly_map[((loop2 + coll_loop) & 127)][((loop - 3) & 127)] =
                  COLL_DOWN_RIGHT;
              poly_map[((loop2 - coll_loop) & 127)][((loop - 3) & 127)] =
                  COLL_UP_RIGHT;
            ...
            if (x_size > 3) {
              poly_map[((loop2 + coll_loop) & 127)][((loop - 4) & 127)] =
                  COLL_DOWN_RIGHT;
              poly_map[((loop2 - coll_loop) & 127)][((loop - 4) & 127)] =
                  COLL_UP_RIGHT;
  ...
  for (loop = 0; loop <= 127; loop += 1) {
    for (loop2 = 0; loop2 <= 127; loop2 += 1) {
      ...
      if (which_graphics_set != DEATH_STAR_GRAPHICS &&
          which_graphics_set != SPACE_GRAPHICS) {
        ...
        if (height_map[loop2 << 1][loop << 1] < 17 &&
            ((arm_random()) & 127) == 0) {
          poly_map[loop2][loop] = 60;
        }
      }

      // Last minute new trees for graphics set earth - randomly replace big
      // trees
      if (which_graphics_set == EARTH_LAND_BASED_GRAPHICS &&
          poly_map[loop2][loop] == EL_BIG_TREE && (arm_random() & 1) == 0) {
      ...
      if (planet_info.space_mission == 1) {
        ...
        if (poly_map[loop2][loop] == 0) {
          ...
          if (poly_map[loop2][loop] == SP_SPACE_GUNL ||
              poly_map[loop2][loop] == SP_SPACE_SAML) {
            height_map[loop2 << 1][loop << 1] = 17;
          }

          if (poly_map[loop2][loop] == SP_SPACE_GUNM ||
              poly_map[loop2][loop] == SP_SPACE_SAMM) {
            height_map[loop2 << 1][loop << 1] = 17 + 32;
          }

          if (poly_map[loop2][loop] == SP_SPACE_GUNH ||
              poly_map[loop2][loop] == SP_SPACE_SAMH) {
  ...
  for (loop = 0; loop <= 127; loop += 1) {
    ...
    if (planet_info.space_mission == 1) {
      ...
      star_coords[loop][0] =
          (((cosine_table[temp_long]) * (cosine_table[temp_long2]))) >> 10;
      star_coords[loop][1] =
          (((sine_table[temp_long]) * (cosine_table[temp_long2]))) >> 10;
