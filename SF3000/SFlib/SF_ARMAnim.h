...
// extern void armanim_initialise (void*);				// Reset
// all animations to active [TAKEN OUT] extern void armanim_update (void*,
// void*);			// Update each animation - CALLED EVERY FRAME
// [TAKEN OUT]
...
extern void
armtex_update(void *, long,
              long); // Update a single animation BACKWARDS OR FORWARDS
#endif
